...
function Detail({ rec, onClose, isOwner, onSaveRecord, preview, playInfo }) {
  ...
  // All three are searches for now, which usually lands on the right album
  // but not always (live records, reissues, deluxe editions).
  //
  // `records.tidal_url` exists and is preferred when set, so the day we can
  // resolve real album links this starts working with no UI change -- but
  // nothing populates it yet. See FEATURE_IDEAS.md for why the Tidal API
  // attempt was parked.
